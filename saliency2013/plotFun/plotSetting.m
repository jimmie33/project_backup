plotDrawStyle={   struct('color',[1,0,0],'lineStyle','--'),...
    ...
    struct('color',[0,0,0],'lineStyle','-v'),...%    struct('color',[1,1,0],'lineStyle','-'),...%yellow
    struct('color',[1,0,1],'lineStyle','-x'),...%pink
    struct('color',[0,1,1],'lineStyle','-o'),...
    struct('color',[0.5,0.5,0.5],'lineStyle','-^'),...%gray-25%
    struct('color',[136,0,21]/255,'lineStyle','-p'),...%dark red
    struct('color',[255,127,39]/255,'lineStyle','-h'),...%orange
    struct('color',[0,162,232]/255,'lineStyle','-d'),...%Turquoise
    struct('color',[163,73,164]/255,'lineStyle','-s'),...%purple    %%%%%%%%%%%%%%%%%%%%
